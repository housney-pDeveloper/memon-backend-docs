...
│       │  다음 역할은 prompt.md + task_prompt.md + 이전 result 읽기      │
│       ▼                                                              │
...
├── result_AI_TECH_LEAD.md       ← 설계 결과
├── result_AI_APPLICATION_ENGINEER.md  ← 구현 결과
├── result_AI_REVIEWER.md        ← 리뷰 결과
├── result_AI_SECURITY_ENGINEER.md     ← 보안 검증 결과
├── result_AI_REFACTOR_ENGINEER.md     ← 리팩토링 결과
└── result_VERIFICATION.md       ← 최종 검증 결과
```
