...
|------|------|------|-----------------|------|
| A | 1 | AI_TECH_LEAD | 01_architecture, 04_backend/CODE_CONVENTION | N |
| B | 2 | AI_*_ARCHITECT | 역할별 AGENT_DOCS_MAPPING 참조 | N |
| C | 3 | AI_*_ENGINEER | 역할별 AGENT_DOCS_MAPPING 참조 | N |
| D | 4-1 | AI_REVIEWER | 01_architecture, 04_backend/CODE_CONVENTION | Y (with 4-2) |
| D | 4-2 | AI_SECURITY_ENGINEER | 01_architecture, 02_security | Y (with 4-1) |
| E | 5 | AI_REFACTOR_ENGINEER | 01_architecture, 04_backend/CODE_CONVENTION | N |

### 핸드오프 흐름

```
prompt.md → task_prompt.md
→ [A] result_AI_TECH_LEAD.md
→ [B] result_AI_*_ARCHITECT.md
→ [C] result_AI_*_ENGINEER.md
→ [D] result_AI_REVIEWER.md + result_AI_SECURITY_ENGINEER.md  ← 병렬, 모두 완료 대기
→ [E] result_AI_REFACTOR_ENGINEER.md
→ result_VERIFICATION.md
```

**병렬 입력 규칙:**
- D단계 (4-1, 4-2): prompt.md + task_prompt.md + 이전 모든 result (TECH_LEAD ~ ENGINEER)
